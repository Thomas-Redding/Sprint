...
void addParseRules(std::vector<bool> &leftToRight, std::vector<ParseRule> &listOfRules) {
	...
	listOfRules.push_back(ParseRule(-10, {}, {}, { function_head, P_IDENTIFIER, block_of_statements_or_class }, function_implementation));
	...
	listOfRules.push_back(ParseRule(-10, {}, {}, { function_head, block_of_statements_or_class, block_of_statements_or_class }, function_implementation));
	listOfRules.push_back(ParseRule(-10, {}, {}, { function_head, bracket_block, block_of_statements_or_class }, function_implementation));
