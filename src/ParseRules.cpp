...
void addParseRules(std::vector<bool> &leftToRight, std::vector<ThomasParseRule> &listOfRules) {
	...
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, T_IDENTIFIER, template_block, T_SEMI_COLON }, function_declaration));
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, curly_brace_block, T_SEMI_COLON }, function_declaration));
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, bracket_block, T_SEMI_COLON }, function_declaration));

	// function implementation
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, raw_type_or_void, curly_brace_block }, function_declaration));
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, T_IDENTIFIER, curly_brace_block }, function_declaration));
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, T_IDENTIFIER, template_block, curly_brace_block }, function_declaration));
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, curly_brace_block, curly_brace_block }, function_declaration));
	listOfRules.push_back(ThomasParseRule(-10, {}, {}, { function_head, bracket_block, curly_brace_block }, function_declaration));
	...
	listOfRules.push_back(ThomasParseRule(100, {}, {}, {ternary_value, T_QUESTION_MARK, ternary_value, T_COLON, ternary_value}, ternary_clause));	// x ? y : z

	listOfRules.push_back(ThomasParseRule(105, {}, {}, {setting_value, T_COLON, setting_value}, colon_clause));											// x : z
	...
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_ASTERISK_EQUALS, setting_value}, setting_clause));							// x *= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_SLASH_EQUALS, setting_value}, setting_clause));							// x /= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_PERCENT_EQUALS, setting_value}, setting_clause));							// x %= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_AMPERSAND_EQUALS, setting_value}, setting_clause));						// x &= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_CARROT_EQUALS, setting_value}, setting_clause));							// x ^= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_VERTICAL_BAR_EQUALS, setting_value}, setting_clause));						// x |= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_EQUAL_EQUALS, setting_value}, setting_clause));							// x <- y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_SHIFT_LEFT_EQUALS, setting_value}, setting_clause));						// x <<= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_SHIFT_RIGHT_EQUALS, setting_value}, setting_clause));						// x >>= y
	listOfRules.push_back(ThomasParseRule(110, {}, {}, {setting_value, T_KEYWORD_IS, setting_value}, setting_clause));								// x is y
	...
	listOfRules.push_back(ThomasParseRule(120, {}, {}, {setting_value, T_SEMI_COLON}, statement));													// x;
